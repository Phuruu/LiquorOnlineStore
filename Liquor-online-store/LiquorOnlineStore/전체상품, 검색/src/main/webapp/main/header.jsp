				...
				<div class="navigation-menu">
					<section class="nav-logo">
						<div class="img-wrapper">
							<a class="main-logo" href="<%=cPath %>/main/main.jsp" alt="메인바로가기"></a>
						</div>
					</section>
					<form action="<%=cPath %>/getSearchList.do" class="list">
			...
			<div class="category-header">
				<div class="category-list-wrapper">
					<ul class="category-list">
						<li class="main">
							<div>
								<a href="<%=cPath %>/main/main.jsp">홈</a>
							</div>
						</li>
